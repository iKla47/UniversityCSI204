...
const mediate = function (info: ResultError) : Error
{
    ...
    {
        case "ER_DUP_ENTRY": 
            return new error.Duplicate (info);
        case "ER_NO_REFERENCED_ROW":
        case "ER_NO_REFERENCED_ROW_2":
            return new error.Constraint (info); 
        case "ER_PARSE_ERROR":
        case "ER_BAD_FIELD_ERROR":
            return new error.Command (info); 
        case "ER_NO_SUCH_TABLE": 
            return new error.NotFound (info); 
        case "ER_ACCESS_DENIED_ERROR": 
        case "ER_DBACCESS_DENIED_ERROR":
            return new error.NotAuthorized (info); 
        case "ECONNREFUSED":
        case "CR_CONNECTION_ERROR":
            return new error.Network (info); 
        case "ER_CON_COUNT_ERROR":
            return new error.NetworkLimit (info);
        case "CR_SERVER_GONE_AWAY":
            return new error.NetworkGone (info);
        default:
            return new error.Unknown (info); 
    }
}
/**
 * 
