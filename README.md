# ระบบร้านขายแผ่นและตลับเกม
(Game Disc and Cartridge E-Commerce System)

## สารบัญ
- [ข้อมูลสมาชิกทีม](#ข้อมูลสมาชิกทีม)
- [หลักการและเหตุผล](#1-หลักการและเหตุผล-rationale)
- [วัตถุประสงค์ของโครงการ](#2-วัตถุประสงค์ของโครงการ-objectives)
- [การออกแบบสถาปัตยกรรมระบบ](#3-ขอบเขตของระบบ-system-scope)
- [แนวทางการพัฒนาตาม SDLC](#4-แนวทางการพัฒนาตาม-sdlc-system-development-life-cycle)
- [เครื่องมือและเทคโนโลยีที่ใช้](#5-เครื่องมือและเทคโนโลยีที่ใช้-tools--technologies)
- [แนวทางการทดสอบระบบ](#6-แนวทางการทดสอบระบบ-testing-approach)
- [ผลลัพธ์ที่คาดว่าจะได้รับ](#7-ผลลัพธ์ที่คาดว่าจะได้รับ-expected-outcomes)
- [แผนการดำเนินงาน](#8-แผนการดำเนินงาน-4-สัปดาห์-work-plan-4-weeks)
