...
`,E=r.div`
  min-height: 32px;
  flex-grow: ${e=>e.$level}
`;Object.freeze(g);var D=`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAACXBIWXMAAC4jAAAuIwF4pT92AAAAEklEQVQ4y2NgGAWjYBSMAggAAAQQAAGFP6pyAAAAAElFTkSuQmCC`,O=function(e){return(0,h.jsx)(O.Root,{visible:e.visible,inset:e.inset,width:e.width,widthMax:e.widthMax,height:e.height,heightMax:e.heightMax,onCancel:e.onCancel,children:e.children})};O.Root=function(e){let t=m.useRef([0,0]),n=`${String(t.current[0])}px`,r=`${String(t.current[1])}px`,i=e.visible??!1,a=e.inset??`${r} auto auto ${n}`,o=e.width??`256px`,s=e.widthMax??`256px`,c=e.height??`auto`,l=e.heightMax??`384px`,u=t=>{t.preventDefault(),t.stopPropagation(),e.onCancel&&e.onCancel()},d=e=>{e.preventDefault(),e.stopPropagation()},f=e=>{t.current=[e.clientX,e.clientY]};return m.useEffect(()=>(window.addEventListener(`mousemove`,f),()=>{window.removeEventListener(`mousemove`,f)}),[]),(0,h.jsx)(m.Activity,{mode:i?`visible`:`hidden`,children:(0,h.jsx)(k,{children:(0,h.jsx)(A,{onClick:u,children:(0,h.jsx)(j,{$inset:a,$width:o,$widthMax:s,$height:c,$heightMax:l,children:(0,h.jsx)(M,{onClick:d,$inset:a,$width:o,$height:c,children:e.children})})})})})},O.Item=function(e){let t=e.icon;return(0,h.jsxs)(N,{onClick:t=>{t.preventDefault(),t.stopPropagation(),e.onClick&&e.onClick()},children:[(0,h.jsx)(()=>typeof t==`string`?(0,h.jsx)(`img`,{src:t,alt:``}):m.isValidElement(t)?t:typeof t==`function`||typeof t==`object`?(0,h.jsx)(t,{}):(0,h.jsx)(`img`,{src:D,alt:``}),{}),e.text]})},O.Provider=function(){let e=s(),[t,n]=m.useState(!1),[r,i]=m.useState((0,h.jsx)(h.Fragment,{})),[a,o]=m.useState(void 0),c=m.useRef(void 0);return m.useEffect(()=>(e.setVisible=e=>{n(e)},e.setChildren=e=>{i(e)},e.setInset=e=>{o(e)},e.setCancel=e=>{c.current=e},()=>{e.setVisible=()=>{},e.setChildren=()=>{},e.setInset=()=>{}}),[]),(0,h.jsx)(O.Root,{visible:t,inset:a,onCancel:c.current,children:r})};var k=r.div`
  overflow: hidden;
...
`,P=function(){return P.Root};P.Root=function(e){return(0,h.jsx)(F,{children:(0,h.jsx)(I,{children:(0,h.jsx)(L,{$visible:e.visible??!1,children:(0,h.jsx)(`p`,{children:e.text})})})})},P.Provider=function(){let[e,t]=(0,m.useState)(!1),[n,r]=(0,m.useState)(``),[i,a]=(0,m.useState)(``),s=(0,m.useRef)(0),c=(0,m.useRef)(0),l=o(),u=()=>{clearTimeout(c.current),c.current=setTimeout(()=>{t(!1)},s.current)};return(0,m.useEffect)(()=>(l.setIcon=e=>{r(e)},l.setText=e=>{a(e)},l.setDuration=e=>{s.current=e},l.setVisible=e=>{t(e),u()},()=>{l.setIcon=()=>{},l.setText=()=>{},l.setDuration=()=>{},l.setVisible=()=>{}}),[l]),(0,m.useEffect)(()=>()=>{clearTimeout(c.current)},[]),(0,h.jsx)(P.Root,{visible:e,icon:n,text:i})};var F=r.div`
  display: block;
  pointer-events: none;
  position: fixed;
  inset: 0px;
...
`,L=r.div`
  ...
  transform: translateY(${e=>e.$visible?`0px`:`64px`});
  transition: transform 250ms linear;
`;export{f as a,p as i,O as n,g as r,P as t};