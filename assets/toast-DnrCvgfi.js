...
`,P=function(){return P.Root};P.Root=function(e){return(0,h.jsx)(F,{children:(0,h.jsx)(I,{children:(0,h.jsx)(L,{$visible:e.visible??!1,children:(0,h.jsx)(`p`,{children:e.text})})})})},P.Provider=function(){let[e,t]=(0,m.useState)(!1),[n,r]=(0,m.useState)(``),[i,a]=(0,m.useState)(``),o=(0,m.useRef)(0),s=(0,m.useRef)(0),c=d(),l=()=>{clearTimeout(s.current),s.current=setTimeout(()=>{t(!1)},o.current)};return(0,m.useEffect)(()=>(c.setIcon=e=>{r(e)},c.setText=e=>{a(e)},c.setDuration=e=>{o.current=e},c.setVisible=e=>{t(e),l()},()=>{c.setIcon=()=>{},c.setText=()=>{},c.setDuration=()=>{},c.setVisible=()=>{}}),[c]),(0,m.useEffect)(()=>()=>{clearTimeout(s.current)},[]),(0,h.jsx)(P.Root,{visible:e,icon:n,text:i})};var F=r.div`
  display: block;
  pointer-events: none;
  position: fixed;
  inset: 0px;
